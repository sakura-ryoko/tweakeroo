...
//		}
	...
	public void render(int mouseX, int mouseY, boolean selected, DrawContext context)
	{
		...
		{
			RenderUtils.drawRect(this.x, y, this.width, this.height, 0x70FFFFFF);
		}
		else if (this.isOdd)
		{
			RenderUtils.drawRect(this.x, y, this.width, this.height, 0x20FFFFFF);
		}
		// Draw a slightly lighter background for even entries
		else
		{
			RenderUtils.drawRect(this.x, y, this.width, this.height, 0x50FFFFFF);
		}

		if (presetSelected)
		{
			RenderUtils.drawOutline(this.x, y, this.width, this.height, 0xFFE0E0E0);
		}

		String line = this.preset.toShortStringStyled();
		this.drawString(this.x + 4, y + 7, 0xFFFFFFFF, line, context);
