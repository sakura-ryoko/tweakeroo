...
public class CachedBlockTags
{
    ...
    public void build(String name, @Nonnull List<String> list)
    {
        ...
        if (list.isEmpty())
        {
            Tweakeroo.LOGGER.warn("CachedBlockTags#build: list '{}' is empty.", name);
            return;
        }
    ...
    public boolean match(String name, Block block)
    {
        ...
        {
            Tweakeroo.LOGGER.warn("CachedBlockTags#match(Block): Invalid tag list '{}'", name);
        }
    ...
    public boolean match(String name, BlockState state)
    {
        ...
        {
            Tweakeroo.LOGGER.warn("CachedBlockTags#match(State): Invalid tag list '{}'", name);
        }
        ...
        public void insertFromString(String entry)
        {
            if (entry.startsWith("#"))
            {
                ...
                if (id != null)
                {
                    ...
                    {
                        Tweakeroo.LOGGER.warn("CachedBlockTags.Entry#insertFromString: Invalid block tag '{}'", entry);
                    }
                }
                else
                {
                    Tweakeroo.LOGGER.warn("CachedBlockTags.Entry#insertFromString: Invalid block tag id '{}'", entry);
                }
            }
            else
            {
                ...
                if (id != null)
                {
                    ...
                    {
                        Tweakeroo.LOGGER.warn("CachedBlockTags.Entry#insertFromString: Invalid block '{}'", entry);
                    }
                }
                else
                {
                    Tweakeroo.LOGGER.warn("CachedBlockTags.Entry#insertFromString: Invalid block id '{}'", entry);
                }
            }
        }
