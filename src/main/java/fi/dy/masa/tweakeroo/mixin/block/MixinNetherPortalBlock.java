...
public abstract class MixinNetherPortalBlock
{
    ...
    private void tweakeroo_disablePortalSound(Level instance, double x, double y, double z,
                                              SoundEvent sound, SoundSource source,
                                              float volume, float pitch, boolean distanceDelay, Operation<Void> original)
    {
