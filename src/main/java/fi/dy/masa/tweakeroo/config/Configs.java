...
public class Configs implements IConfigHandler
{
    ...
    public static class Lists
    {
        ...
        public static final ConfigStringList PREFER_SILK_TOUCH                  = new ConfigStringList("preferSilkTouch", ImmutableList.of(), "tweakeroo.config.lists.comment.preferSilkTouch").translatedName("tweakeroo.config.lists.name.preferSilkTouch");
