    ...
    static Stream<Arguments> toolConfigTestData()
    {
        try
        {
            ...
            return Stream.of(
                    ...
                    Arguments.of(new ConfigTestCase(configToolSwap("TOOL_SWAP_PICKAXE_OVERRIDE"), new ItemStack(Items.WOODEN_PICKAXE), new ItemStack(Items.DIAMOND_SWORD), glass, true, "pickaxeOverride: wooden pick beats diamond sword on glass (no tool tags, but in override list)")),
                    ...
                    // ================================================================
                    Arguments.of(new ConfigTestCase(configToolSwap("TOOL_SWAP_SILK_TOUCH_ORES"), withEnchant(new ItemStack(Items.WOODEN_PICKAXE), Enchantments.SILK_TOUCH, 1), diamondPickNoSilkTouch(), coalOre, true, "silkTouchOres: wooden pick+ST beats diamond pick+Fort+Mend+Unbreak on coal ore")),
                    ...
                    Arguments.of(new ConfigTestCase(configToolSwap(), new ItemStack(Items.DIAMOND_PICKAXE), withEnchant(new ItemStack(Items.WOODEN_PICKAXE), Enchantments.SILK_TOUCH, 1), coalOre, true, "silkTouchOres OFF: diamond pick beats wooden pick+ST on ore (ST ignored, material wins)")),
                    ...
                    // ================================================================
                    Arguments.of(new ConfigTestCase(configToolSwap(), new ItemStack(Items.GOLDEN_PICKAXE), new ItemStack(Items.STONE_PICKAXE), stone, true, "fasterTool: gold pick (12.0 speed) beats stone pick (4.0) on stone")),
                    Arguments.of(new ConfigTestCase(configToolSwap(), new ItemStack(Items.GOLDEN_AXE), new ItemStack(Items.STONE_AXE), oakLog, true, "fasterTool: gold axe (12.0 speed) beats stone axe (4.0) on oak log")),
                    ...
                    Arguments.of(new ConfigTestCase(configToolSwap("TOOL_SWAP_SILK_TOUCH_FIRST"), withEnchant(new ItemStack(Items.WOODEN_PICKAXE), Enchantments.SILK_TOUCH, 1), diamondPickNoSilkTouch(), enderChest, true, "stFirst-only: wooden pick+ST beats diamond pick+Fortune on ender chest")),
                    ...
                    Arguments.of(new ConfigTestCase(configToolSwap("TOOL_SWAP_SILK_TOUCH_ORES"), withEnchant(new ItemStack(Items.WOODEN_PICKAXE), Enchantments.SILK_TOUCH, 1), diamondPickNoSilkTouch(), coalOre, true, "stOres-only: wooden pick+ST beats diamond pick+Fortune on ore")),
                    ...
                    Arguments.of(new ConfigTestCase(configToolSwap("TOOL_SWAP_SILK_TOUCH_OVERRIDE"), withEnchant(new ItemStack(Items.WOODEN_PICKAXE), Enchantments.SILK_TOUCH, 1), diamondPickNoSilkTouch(), stone, true, "stOverride-only: wooden pick+ST beats diamond pick+Fortune on stone")),

                    // ================================================================
                    // All silk touch configs — earliest matching rule decides
                    // ================================================================
                    Arguments.of(new ConfigTestCase(configToolSwap("TOOL_SWAP_PREFER_SILK_TOUCH", "TOOL_SWAP_SILK_TOUCH_FIRST", "TOOL_SWAP_SILK_TOUCH_ORES", "TOOL_SWAP_SILK_TOUCH_OVERRIDE"), withEnchant(new ItemStack(Items.WOODEN_PICKAXE), Enchantments.SILK_TOUCH, 1), diamondPickNoSilkTouch(),
                            coalOre, true, "allSilk: wooden pick+ST beats diamond pick+Fortune on ore (all silk configs on)")),
                    Arguments.of(new ConfigTestCase(configToolSwap("TOOL_SWAP_PREFER_SILK_TOUCH", "TOOL_SWAP_SILK_TOUCH_FIRST", "TOOL_SWAP_SILK_TOUCH_ORES", "TOOL_SWAP_SILK_TOUCH_OVERRIDE"), withEnchant(new ItemStack(Items.WOODEN_PICKAXE), Enchantments.SILK_TOUCH, 1), diamondPickNoSilkTouch(),
                            enderChest, true, "allSilk: wooden pick+ST beats diamond pick+Fortune on ender chest")),
                    Arguments.of(new ConfigTestCase(configToolSwap("TOOL_SWAP_PREFER_SILK_TOUCH", "TOOL_SWAP_SILK_TOUCH_FIRST", "TOOL_SWAP_SILK_TOUCH_ORES", "TOOL_SWAP_SILK_TOUCH_OVERRIDE"), withEnchant(new ItemStack(Items.WOODEN_PICKAXE), Enchantments.SILK_TOUCH, 1), diamondPickNoSilkTouch(),
                            stone, true, "allSilk: wooden pick+ST beats diamond pick+Fortune on stone (override block)")),
